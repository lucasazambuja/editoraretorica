...
var FCGrid$ = function () {
  ...
  var options = {
    ...
    iconArrowPrevIMG : 'icon-grid-arrow-prev.svg?cccfc=1',
    iconArrowNextIMG : 'icon-grid-arrow-next.svg?cccfc=1',
    ...
    magicZoomFC: function(id, novoArray, novoArrayAmp, FC_MaxImages, refreshZoom){
      ...
      for (var i=0;i<=FC_MaxImages;i++)
      {
        if(i===0)
        {
          ...
          sHtmlZoom+="<div id=\"fc-grid-api-controls\"><img src=\""+ FC$.PathImg + options.iconArrowPrevIMG +"\" class=\"fc-grid-api-controls-prev\" id=\"fc-grid-api-controls-prev-remove\" alt=\"Voltar\" onclick=\"MagicZoom.prev('zoom2');\"><a href="+imgAmpMini+" class='MagicZoom' id=zoom2 data-options='hint:off' data-mobile-options='textClickZoomHint:' rel=\"selectors-class:active; zoom-width:350px; zoom-height:350px; selectors-change:mouseover;\"><img src="+ imgDetMini +" alt='"+sNameProd+"'></a><img src=\""+ FC$.PathImg + options.iconArrowNextIMG +"\" class=\"fc-grid-api-controls-next\" id=\"fc-grid-api-controls-next-remove\" alt=\"Voltar\" onclick=\"MagicZoom.next('zoom2');\"></div><br>"
                    +"<a href=\""+imgAmpMini+"\" data-zoom-id=\"zoom2;\" rel=\"zoom-id:zoom2;\" rev=\""+ imgDetMini +"\"><img src=\""+ imgDetMini +"\" alt='"+sNameProd+"' width=65 height=65 class=ZoomIMG2></a>";
        }
        else{
          ...
          sHtmlZoom+="<a href="+imgAmpMini+" data-zoom-id=\"zoom2;\" rel='zoom-id:zoom2;' rev="+ imgDetMini +"><img src="+ imgDetMini +" alt='"+sNameProd+"' width=65 height=65 class=ZoomIMG2></a>";
        }
      }
  ...
  function fnBuyProduct(posBtnComprar){
    ...
    if(options.cartOnPage){
      ...
      if(sNameColor!=='')sParamsProd+='&Cor_'+ IDSubProd +'='+ EncodeParamFC(fn.charCode(sNameColor)).replace(/\+/g,'%2B');
